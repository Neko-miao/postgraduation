...
- 介绍基于边坍缩的网格简化算法  
在计算机图形学领域，网格简化算法已经相当成熟了，其算法思想可以分为以下5类：基于顶点删除[引用文献]，基于顶点集群[引用文献]，基于区域合并[引用文献]，基于细分网格以及基于迭代的边坍缩[引用文献]。
- 算法思想  
- GPU友好结构  
- 三角形重构  
- 讲解如何实现连续LoD
